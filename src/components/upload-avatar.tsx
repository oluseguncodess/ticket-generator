...
export default function UploadAvatar() {
  return (
    <div className="flex flex-col gap-4 mt-10 md:mt-13 w-full md:max-w-125">
      <h2 className="font-bold">Upload Avatar</h2>
      <div className="border-dashed w-full h-40 border-2 border-neutral-0/25 rounded-2xl bg-neutral-700/30 flex flex-col items-center justify-center gap-5 p-2">
        ...
        <p className="text-base text-center">Drag and drop or click to upload</p>
      </div>
